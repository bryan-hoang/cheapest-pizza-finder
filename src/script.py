...
def scrape(address, radius):
    ...
    driver.get(
        'https://www.yellowpages.ca/search/si/1/pizza/%s', formatted_address)
    ...
    for box in boxes:
        try:
            ...
            box_link = box_element.find_element_by_tag_name(
    ...
    return render_template(
        'scrape.html', template_address=address, price_dict=dict)
